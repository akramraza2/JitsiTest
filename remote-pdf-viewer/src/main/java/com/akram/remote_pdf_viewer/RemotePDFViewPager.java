 ...
 */
package com.akram.remote_pdf_viewer;
...
import com.akram.remote_pdf_viewer.remote.DownloadFile;
import com.akram.remote_pdf_viewer.remote.DownloadFileUrlConnectionImpl;
import com.akram.remote_pdf_viewer.util.FileUtil;
...
public class RemotePDFViewPager extends ViewPager implements DownloadFile.Listener {
    ...
    protected OkHttpClient dohClient;

    public RemotePDFViewPager(Context context, String pdfUrl, DownloadFile.Listener listener, OkHttpClient dohClient) {
        super(context);
        this.context = context;
        this.listener = listener;
        this.dohClient = dohClient;

        init(new DownloadFileUrlConnectionImpl(context, new Handler(Looper.getMainLooper()), this,dohClient), pdfUrl);
    }
